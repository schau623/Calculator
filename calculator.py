...
class Application (Frame):
    def __init__(self, master):
        ...
        self.button_add = Button(self, text = "+", padx = 39, pady = 20, command = lambda: click('+'))
        self.button_equal = Button(self, text = "=", padx = 91, pady = 20, command = lambda: click('='))
        self.button_clear = Button(self, text = "CLEAR", padx = 79, pady = 20, command = lambda: clear())
